...
<template>
	<div class="flex">
		<VaSelect v-model="currentIdentifier" :options="identifiers"></VaSelect>
		<VaSelect v-model="keyType" :options="keyTypes"></VaSelect>
		<!--<VaSelect
    ...
    >
		...
		<VaInput v-if="['Static', 'Dynamic'].includes(keyType)" v-model="staticKey">
		</VaInput>
	</div>
</template>
