...
<template>
  <div class="flex flex-col ml-8 gap-3">
    <div class="flex flex-col items-start gap-3">
      <VaSelect :options="listTypes" v-model="listTypeTemp"></VaSelect>
      <div class="flex flex-row gap-3 items-center">
        ...
        <VaCheckbox v-model="isRange" class="checkbox-border min-w-max">
        </VaCheckbox>
      </div>
      <range v-if="isRange" v-model:range="rangeData"></range>
    </div>
