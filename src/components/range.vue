...
<template>
  <div class="flex flex-col ml-8 border-2 border-tertiary p-2 rounded-lg gap-3">
    <VaInput
      preset="primary"
      type="number"
      v-model="min"
      placeholder="min"
      inputClass="border-solid border-slate-300"
    />
    <VaInput preset="primary" type="number" v-model="max" placeholder="max" />
